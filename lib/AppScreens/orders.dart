...
class OrderDescendent extends StatelessWidget {
  OrderDescendent({@required this.orderModel}
      );
...
//                  getSyncAPI();
        ...
        body: SelectCustomer(orderModel: orderModel)
...
class SelectCustomer extends StatefulWidget {
  SelectCustomer({@required this.orderModel}
      );
  final NewAppStateModel orderModel;
